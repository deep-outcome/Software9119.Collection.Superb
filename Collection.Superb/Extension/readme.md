...
- `IEnumerableExtension`
    ...
    - <strong style="background-color:rgba(186 246 226 / 0.63)"><u>`AsOrTo` or `Into` for chosen [`System.Collections.Concurrent` Namespace](https://learn.microsoft.com/en-us/dotnet/api/system.collections.concurrent?view=net-10.0) types</u></strong>
        ...
        ```
        - [`BlockingCollection<Item>? AsBlockingCollection<Item>(IProducerConsumerCollection<Item>, int?, EnumerableNullBehavior)`](https://github.com/deep-outcome/Software9119.Collection.Superb/blob/HEAD/Collection.Superb/Extension/IEnumerableExtension/IEnumerableExtension.As.System.Collections.Concurrent.cs#L47) – wraps `IProducerConsumerCollection<T>` into blocking collection
    ...
    - <strong style="background-color:rgba(186 246 226 / 0.63)"><u>`AsOrTo` or `Into` for chosen [`System.Collections.ObjectModel` Namespace](https://learn.microsoft.com/en-us/dotnet/api/system.collections.objectmodel?view=net-10.0) types</u></strong>
        ...
        - [`ReadOnlySet<Item>? AsReadOnlySet<Item>(ISet<Item>?, EnumerableNullBehavior)`](https://github.com/deep-outcome/Software9119.Collection.Superb/blob/HEAD/Collection.Superb/Extension/IEnumerableExtension/IEnumerableExtension.As.System.Collections.ObjectModel.cs#L35) – wraps set into read-only set
