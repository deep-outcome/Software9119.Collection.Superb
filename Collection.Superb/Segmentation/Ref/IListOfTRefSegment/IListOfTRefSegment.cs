  ...
  where T : struct, IList<U?>, allows ref struct
{
  ...
  /// <summary>
  /// Equality comparer used by <see cref="Contains(U?)"/> and <see cref="IndexOf(U?)"/> methods.
  /// </summary>
  public IEqualityComparer<U> EqualityComparer
  {
    ...
    private set => equalityComparer = (value ?? EqualityComparer<U>.Default);
  }
  ...
  readonly public bool Contains ( U? item )
  ...
  readonly public bool Contains ( U? item, IEqualityComparer<U> comparer )
