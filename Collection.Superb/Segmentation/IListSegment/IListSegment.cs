...
#pragma warning restore CA1062 // Validate arguments of public methods
  ...
  /// <summary>
  /// Equality comparer used by <see cref="Contains(object?)"/> and <see cref="IndexOf(object?)"/> methods.
  /// </summary>
  public IEqualityComparer<object> EqualityComparer
  {
    ...
    private set => equalityComparer = (value ?? EqualityComparer<object>.Default);
  }
  ...
  readonly public bool Contains ( object? item )
  ...
  readonly public bool Contains ( object? item, IEqualityComparer<object> comparer )
  ...
  /// Creates slice of this segment.
  /// </summary>
  readonly public IListSegment Slice ( NonNegativeInt32 offset, NonNegativeInt32 count )
  {
    int startIndex = SegmentationValidator.CorrelateIndex(offset, this.offset);
    return new IListSegment ( list, startIndex, count );
  }

  /// <summary>
  /// Copies segment into new <c>T[]</c>.
  /// </summary>
  readonly public object? [] ToArray ()
  {
