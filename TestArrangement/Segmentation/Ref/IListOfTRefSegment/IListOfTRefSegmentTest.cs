...
public class IListOfTRefSegmentTest
{
  ...
  public void DefaultCtor ()
  {
    ...
    IListRefSegment<ArraySegment<string?>, string> segment = new ( list, comparer );
  ...
  public void OffsetCtor ( int offset, int count )
  {
    ...
    IListRefSegment<ArraySegment<string?>, string> segment = new ( list, offset: offset, count, comparer );
  ...
  public void Slice ( int offset )
  {
    ...
    RefList<int> list = new ([1,2,3,4,5]);
    IListRefSegment<RefList<int>, int> segment = new (list);
    IListRefSegment<RefList<int>, int> test = segment.Slice(offset);
  ...
  {    
    RefList<int> list = new ([1,2,3,4,5]);
    IListRefSegment<RefList<int>, int> segment = new (list);
    IListRefSegment<RefList<int>, int> test = segment.Slice(offset, count);
  ...
  public void ToArray ( int offset, int count )
  {
    ...
    RefList<int> list = new (array);
    IListRefSegment<RefList<int>, int> segment = new (list, offset, count);
