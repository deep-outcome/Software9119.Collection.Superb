...
public class IReadOnlyListOfTSegmentTest
{
  ...
  public void DefaultCtor ()
  {
    ...
    IReadOnlyListSegment<string> segment = new ( list, comparer );
  ...
  {
    IReadOnlyListSegment<int> segment = new ([1,2,3,4,5]);
  ...
  public void Slice ( int offset )
  {
    ...
    IReadOnlyListSegment<int> segment = new (arraySegment.Array!);
    IReadOnlyListSegment<int> test = segment.Slice(offset);
  ...
  public void Slice_WithCount ( int offset, int count )
  {
    ArraySegment<int> arraySegment = new([1,2,3,4,5], offset, count);
    IReadOnlyListSegment<int> segment = new (arraySegment.Array!);
    IReadOnlyListSegment<int> test = segment.Slice(offset, count);
  ...
  {
    ArraySegment<int> arraySegment = new([1,2,3,4,5], offset, count);
    IReadOnlyListSegment<int> segment = new (arraySegment.Array!, offset, count);
...
#pragma warning restore CS1718 // Comparison made to same variable
  ...
  {
    Func<ArraySegment<int>, IReadOnlyListSegment<int>>[] casts =
    [
      a => a,
      a => IReadOnlyListSegment<int>.ToIReadOnlyListSegment(a)
    ];

    foreach (Func<ArraySegment<int>, IReadOnlyListSegment<int>> c in casts)
    {
      int[] array = [1,2 ,3, 4, 5];
      ArraySegment<int> segment = new ( array, offset: offset, count );
      IReadOnlyListSegment<int> test = c(segment);
